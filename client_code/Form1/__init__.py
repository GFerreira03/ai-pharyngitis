...
class Form1(Form1Template):
  ...
  def send_click(self, **event_args):
    if (self.age_text.text is None 
        or self.temperature_text.text is None
        or self.radio_pain_1.get_group_value() is None
        or self.radio_swollenadp_1.get_group_value() is None
        or self.radio_tender_1.get_group_value() is None
        or self.radio_tonsillarswelling_1.get_group_value() is None
        or self.radio_exudate_1.get_group_value() is None
        or self.radio_cough_1.get_group_value() is None
        or self.radio_rino_1.get_group_value() is None
        or self.radio_conjunctivitis_1.get_group_value() is None
        or self.radio_erythema_1.get_group_value() is None
        or self.radio_abdopain_1.get_group_value() is None
        or self.radio_nauseavomit_1.get_group_value() is None
        or self.radio_headache_1.get_group_value() is None
        or self.radio_scarlet_1.get_group_value() is None
        or self.radio_petechiae_1.get_group_value() is None):
